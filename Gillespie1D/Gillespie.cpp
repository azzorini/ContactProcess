...
int main() {
	double tmax = 100000, t_save = 0, freq_t = 1;
	int N = 1000;
	double landa = 4;
	...
	simulacion.save_to_pbm("sim1d_4.pbm");

	if (simulacion[0] == 0 && simulacion[N-1] == 0) cout << "NO, la simulación no se completó" << endl;
	else cout << "SÍ, la simulación se completó" << endl;
